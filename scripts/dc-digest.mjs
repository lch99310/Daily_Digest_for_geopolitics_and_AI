...
- **地理分區規則（嚴格遵守）**：
  - 🏗️「APAC 資料中心動態 (Top 3)」：**僅限**發生在亞太地區（APAC）的資料中心產業事件。包含：日本、韓國、台灣、中國、香港、東南亞（新加坡、馬來西亞、印尼、泰國、越南、菲律賓等）、印度、澳洲、紐西蘭等亞太區域。
  - 🌐「ROW 資料中心動態 (Top 3)」：**僅限**發生在非 APAC 地區的資料中心產業事件。ROW = Rest of World，包含：北美、歐洲、中東、非洲、拉丁美洲等。
  - 🔥「Bytedance / TikTok 資料中心動態」：從上方素材中挑出所有與 ByteDance、TikTok、抖音相關的資料中心新聞。如果今日素材中沒有相關新聞，則寫「本日無相關更新」。
  - 請勿將不同分區的事件混淆歸類。判斷標準是事件的**地理發生地點**。
...
🔥 Bytedance / TikTok 資料中心動態

{如有相關新聞，用與上方相同的卡片格式呈現（標題、摘要、影響、來源）。可有 1 至 3 則。}
{如今日素材中無相關新聞，僅寫：「本日無相關更新」}
